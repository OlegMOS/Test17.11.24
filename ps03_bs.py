...
def get_english_words():
    ...
    try:
        ...
        # Получаем слово. text.strip удаляет все пробелы из результата в начале и в конце фразы
...
def word_game():
    ...
    while True:
        ...
        # Начинаем игру
        print(f"Значение слова - {word_definition_ru.text.strip()}")
        user = input("Что это за слово? ")
        if user == word_ru.text.strip():
            print("Все верно!")
        else:
